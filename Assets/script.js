...
function getResponseWeather(cityName){
    ...
    var queryURL2 = "https://api.openweathermap.org/data/2.5/uvi?appid="+"&lat=" + CoordLat +"&lon=" + CoordLon;
        $.ajax({
            url: queryURL2,
            method: "GET"
            ...
            if(responseuv.value > 0 && responseuv.value <=7){
        ...
        var queryURL3 = "https://api.openweathermap.org/data/2.5/forecast?q=" + cityName + "&appid=";
            $.ajax({
            url: queryURL3,
            method: "GET"
